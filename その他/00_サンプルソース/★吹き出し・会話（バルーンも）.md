...
★イメージ。少し動きがわるい
[プレビュー](http://localhost:54321/preview-20260215-120351.html)
...
以下をコピーして `.html` ファイルとして保存すれば、��ぐに動作確認できます：

## 動作内容

1. **スクロー���ダウン**すると吹き出しエリアが画面に入る
2. **3つの吹き出しが風船のようにポンッと拡大**しながら表示される
3. 2番目だけ**右側から吹き出し**が出る（三角形の向きが逆）
